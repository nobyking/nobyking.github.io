	...
	var header = '\
		<div class="mod_gst">\
			<div class="mod_gst_main">\
				<a id="logo-btn" href="http://tq.qq.com?ADTAG=QBCF&adtag=QBCF" title="QQ浏览器特权中心" target="_blank"></a>\
				<a id="tq" href="http://tq.qq.com?ADTAG=QBCF&adtag=QBCF" target="_blank"></a>\
				<div class="mod_gst_userinfo" id="navUserInfo"></div>\
                <a id="header-qb" title="QQ浏览器下载" href="http://dldir1.qq.com/invc/tt/QQBrowser_Setup_CF.exe" onclick="report(\'BROWSER.ACTIVITY.CF.QBDOWNLOADCLICK\');"></a>\
			</div>\
		</div>';
