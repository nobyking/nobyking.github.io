	...
	var header = '\
		<div class="mod_gst">\
			<div class="mod_gst_main">\
				<a id="logo-btn" href="http://tq.qq.com?ADTAG=QBFIFA&adtag=QBFIFA" title="QQ浏览器特权中心" target="_blank"></a>\
				<a id="tq" href="http://tq.qq.com?ADTAG=QBFIFA&adtag=QBFIFA" target="_blank"></a>\
				<div class="mod_gst_userinfo" id="navUserInfo"></div>\
                <a id="header-qb" title="QQ浏览器下载" href="http://dldir1.qq.com/invc/tt/QQBrowser_Setup_FIFAonline3.exe" onclick="report(\'BROWSER.ACTIVITY.FIFA.QBDOWNLOADCLICK\');"></a>\
			</div>\
		</div>';
