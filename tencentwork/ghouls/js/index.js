...
var tips = {
    ...
    8 : function(){
        html = "<div class='popContTit'>亲爱的用户</div>\
                ...
                <div class='P_btns'>\
                    <a href='http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=' class='btn btn_downloadQB' onclick='report(\"BROWSER.ACTIVITY.GHOULS.DOWNLOADQBCLICK\")'>下载QQ浏览器</a>\
                </div>";
        return html;
    },
    7 : function(k){
        ...
        html = "<div class='popContTit'>亲爱的用户</div>\
                ...
                <div class='P_btns'>\
                    <a href='http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=' class='btn btn_downloadQB2' onclick='report(\"BROWSER.ACTIVITY.GHOULS.DOWNLOADQBCLICK2\")'>下载专用版QQ浏览器</a>\
                </div>";
        return html;
    },
    6 : function(){
        ...
        if(k == 1){
            html = "<div class='popContTit'>QQ浏览器</div>\
                    <div class='contentGifts'>\
                        <h3 class='gifts_title'>\
                            <p>恭喜您获得</p>\
                            <p class='tit'>《鬼吹灯之寻龙诀》电影票一张</p>\
                        </h3>\
                        <div class='giftsCdkey'>兑换码为：" + cdkey + "</div>\
                        <div class='giftsExplain' style=''>\
                            <div class='giftsTips' style=''>\
                                <p>使用规则：</p>\
                                <p><span>1、</span><em>绑定：下载并激活格瓦拉@电影APP→注册/登陆→点击个人中心→票券/活动码→输入/粘贴→绑定</em></p>\
                                <p><span>2、</span><em>使用：选择影片、影院、场次、座位→点击活动→选择票券→确认订单→凭取票短信至影院自助取票机取票</em></p>\
                                <p><span>3、</span><em>规则：①需下载格瓦拉@电影APP使用，每台手机+每个ID+手机号，限用两次 </em></p>\
                                <p class='rule_tips'>②有效期：2015.11.30，适用格瓦拉全国合作影院</p>\
                                <p class='rule_tips'>③电影节、见面会等特殊场次无法使用</p>\
                            </div>\
                        </div>\
                    </div>";
        } else if(k == 2){
            html = "<div class='popContTit'>QQ浏览器</div>\
                    <div class='contentGifts'>\
                        <h3 class='gifts_title'>\
                            <p>恭喜您获得</p>\
                            <p class='tit'>《鬼吹灯之寻龙诀》电影红包一个 </p>\
                        </h3>\
                        <div class='giftsExplain'>\
                            <div class='giftsCode'><img src='http://event.browser.qq.com/stdl/activity/ghouls/images/code.jpg' width='120' height='120'><span>扫描二维码获取</span></div>\
                            <div class='giftsTips_half' style=''>\
                                <p>使用规则：</p>\
                                <p><span>1、</span><em>输入手机号点击立即领取，将获得格瓦拉电影10元代金券一张</em></p>\
                                <p><span>2、</span><em>每个手机号限额领取1次，数量有限先到先得</em></p>\
                                <p><span>3、</span><em>中奖后，请使用输入的手机号注册/登录，若中票券可在\"我的\"里查看票券/活动码</em></p>\
                                <p><span>4、</span><em>使用时请在选择完影片，影院，座位，确认订单时勾选活动使用兑换</em></p>\
                                <p><span>5、</span><em>票券有效期至2015年12月31日</em></p>\
                                <p><span>6、</span><em>凡以不正当手段（包括但不限于作弊、扰乱系统、实施网络攻击等）参与本次活动的，格瓦拉有权终止 其参与活动，取消其使用资格（如奖品已发放，格瓦拉有权追回）</em></p>\
...
(function (window,$) {
    Page = qv.zero.extend(qv.zero.AbstractPage, {
        ...
        getLucky: function () {
            ...
            zUtil.ensureLogin(function () {
                ...
                report("BROWSER.ACTIVITY.GHOULS.GETLUCKY");
            });
        },
        //查询中奖记录
        queryGift: function () {
            zUtil.ensureLogin(function () {
                zHttp.send({actid: 77782}, function (res) {
                    if (res.ret == 0) {
                        var _htmlArr = [],
                            _html = '',
                            count = 0,
                ...
                report("BROWSER.ACTIVITY.GHOULS.QUERYGIFTSCLICK");
            });
        }
    });
    ...
    var shareFunc = function(type,url){
        report('BROWSER.ACTIVITY.GHOULS.SINA');
        var _url = "http://tq.qq.com/events/ghouls/index.html?ADTAG=sina";
        var _pic = "http://event.browser.qq.com/stdl/activity/ghouls/img/share.jpg";
        var _title = "#QQ浏览器邀你看首映，免费电影票等你领！";
        var _description = "摸金贺岁，QQ浏览器请你看《鬼吹灯之寻龙诀》！还原原著的良心之作，陈坤、舒淇、黄渤、Angelababy带你“燃”爆贺岁档。速来领票→_→";
    ...
    zHttp.send({actid: 77775}, function (res) {
