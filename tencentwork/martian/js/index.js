...
var tips = {
    ...
    8 : function(){
        html = "<div class='popContTit'>亲爱的用户</div>\
                ...
                <div class='P_btns'>\
                    <a href='http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=' class='btn btn_downloadQB' onclick='report(\"BROWSER.ACTIVITY.MARTIAN.DOWNLOADQBCLICK\")'>下载QQ浏览器</a>\
                </div>";
        return html;
    },
    7 : function(k){
        ...
        html = "<div class='popContTit'>亲爱的用户</div>\
                ...
                <div class='P_btns'>\
                    <a href='http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=' class='btn btn_downloadQB2' onclick='report(\"BROWSER.ACTIVITY.MARTIAN.DOWNLOADQBCLICK2\")'>下载专用版QQ浏览器</a>\
                </div>";
        return html;
    },
    6 : function(){
        ...
        if(k == 1){
                    ...
                    <div class='contentGifts'>\
                        ...
                        <div class='giftsExplain' style=''>\
                            <div class='giftsTips' style=''>\
                                ...
                                <p>3、规则：①需下载格瓦拉@电影 APP使用，每台手机+每个ID+手机号，限用两次 </p>\
            ...
            html = "<div class='popContTit'>QQ浏览器</div>\
                    <div class='contentGifts'>\
                        <h3 class='gifts_title'>\
                            <p>恭喜您获得</p>\
                            <p class='tit'>《火星救援》电影红包一个 </p>\
                        </h3>\
                        <div class='giftsExplain'>\
                            <div class='giftsCode'><img src='http://event.browser.qq.com/stdl/activity/martian/images/code2.jpg' width='120' height='120'><span>扫描二维码获取</span></div>\
...
(function (window,$) {
    Page = qv.zero.extend(qv.zero.AbstractPage, {
        ...
        getLucky: function () {
            ...
            zUtil.ensureLogin(function () {
                ...
                report("BROWSER.ACTIVITY.MARTIAN.GETLUCKY");
            });
        },
        //查询中奖记录
        queryGift: function () {
            zUtil.ensureLogin(function () {
                zHttp.send({actid: 73003}, function (res) {
                    if (res.ret == 0) {
                        var _htmlArr = [],
                            _html = '',
                            count = 0,
                ...
                report("BROWSER.ACTIVITY.MARTIAN.QUERYGIFTSCLICK");
            });
        }
    });
    ...
    var shareFunc = function(type,url){
        report('BROWSER.ACTIVITY.MARTIAN.SINA');
        var _url = "http://tq.qq.com/events/martian/index.html?ADTAG=sina";
        var _pic = "http://event.browser.qq.com/stdl/activity/martian/img/share.jpg";
        var _title = "#QQ浏览器邀你看首映，免费电影票等你领！";
        var _description = "科幻大片《火星救援》11月25日火热上映！2015年必须去影院看的年度神作，QQ浏览器请你免费看，速戳→_→";
