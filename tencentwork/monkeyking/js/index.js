...
var tips = {
    ...
    8 : function(){
        html = "<div class='popContTit'>亲爱的用户</div>\
                ...
                <div class='P_btns'>\
                    <a href='http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=' class='btn btn_downloadQB' onclick='report(\"BROWSER.ACTIVITY.MONKEYKING.DOWNLOADQBCLICK\")'>下载QQ浏览器</a>\
                </div>";
        return html;
    },
    7 : function(k){
        ...
        html = "<div class='popContTit'>亲爱的用户</div>\
                ...
                <div class='P_btns'>\
                    <a href='http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=' class='btn btn_downloadQB2' onclick='report(\"BROWSER.ACTIVITY.MONKEYKING.DOWNLOADQBCLICK2\")'>下载专用版QQ浏览器</a>\
                </div>";
        return html;
    },
    6 : function(){
        ...
        if(k == 1){
            html = "<div class='popContTit'>QQ浏览器</div>\
                    <div class='contentGifts'>\
                        <h3 class='gifts_title'>\
                            <p>恭喜您</p>\
                            <p class='tit'>获得《三打白骨精》电影票一张</p>\
                        </h3>\
                        <div class='giftsCdkey'>兑换码为：" + cdkey + "</div>\
                        <div class='giftsExplain' style=''>\
                            <div class='giftsTips' style=''>\
                                <p class='ptit'>兑换步骤：</p>\
                                <p class='rule_order'><span>1)</span><em>打开百度糯米APP，点击右下角“我的”->订单下面的“电影”->预售->激活兑换码；也可以用手机浏览器直接访问“m.dianying.baidu.com”->个人中心（右下角图标）->我的兑换码->激活兑换码；</em></p>\
                                <p class='rule_order'><span>2)</span><em>在激活兑换码页面，输入兑换码（如有多个码，请依次输入，并在每输入一个码后点击右侧的“添加”按钮），最后点击底部“完成”按钮，进入选座流程：选择影院-> 选择观影场次->选择座位->确认兑换；</em></p>\
                                <p class='rule_order'><span>3)</span><em>有效期：2016年2月5日至2月22日</em></p>\
                            </div>\
                        </div>\
                    </div>";
        } else if(k == 2){
            html = "<div class='popContTit'>QQ浏览器</div>\
                      <div class='contentGifts'>\
                        <h3 class='gifts_title'>\
                            <p>恭喜您</p>\
                            <p class='tit'>获得《三打白骨精》电影红包一个 </p>\
                        </h3>\
                        <div class='giftsExplain'>\
                            <div class='giftsCode'><img src='http://event.browser.qq.com/stdl/activity/monkeyking/images/code.jpg' width='140' height='140'><span>微信扫码领取</span></div>\
                            <div class='giftsTips' style=''>\
                                <p class='ptit'>使用规则：</p>\
...
(function (window,$) {
    Page = qv.zero.extend(qv.zero.AbstractPage, {
        ...
        getLucky: function () {
            ...
            zUtil.ensureLogin(function () {
                ...
                report("BROWSER.ACTIVITY.MONKEYKING.GETLUCKY");
            });
        },
        //查询中奖记录
        queryGift: function () {
            zUtil.ensureLogin(function () {
                zHttp.send({actid: 87393}, function (res) {
                    if (res.ret == 0) {
                        var _htmlArr = [],
                            _html = '',
                            count = 0,
                ...
                report("BROWSER.ACTIVITY.MONKEYKING.QUERYGIFTSCLICK");
            });
        }
    });
    ...
    var shareFunc = function(type,url){
        report('BROWSER.ACTIVITY.MONKEYKING.SINA');
        var _url = "http://tq.qq.com/events/monkeyking/index.html?ADTAG=sina";
        var _pic = "http://event.browser.qq.com/stdl/activity/monkeyking/img/share.jpg";
        var _title = "#QQ浏览器邀你看首映，免费电影票等你领！";
        var _description = "猴年咯，QQ浏览器带你免费看美猴王《三打白骨精》！天王郭富城变身孙悟空，智斗“妖皇”巩俐，更有冯绍峰、小沈阳、罗仲谦逗比出征！战天斗地，抢票不能等→";
