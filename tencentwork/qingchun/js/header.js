	...
	var header = '\
		<div class="mod_gst">\
			<div class="mod_gst_main">\
                ...
                <a id="header-qb" title="QQ浏览器下载" href="http://dldir1.qq.com/invc/tt/QQBrowser_Setup_Privilegecenter.exe#?ADTAG=SNO=" onclick="report(\'BROWSER.ACTIVITY.QINGCHUN.QBDOWNLOADCLICK\');"></a>\
			</div>\
		</div>';
