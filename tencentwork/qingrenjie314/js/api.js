...
(function(W, $){
    ...
    var isQQBrowser = (/QQBrowser/i.test(navigator.userAgent)) ? true : false;
    ...
    var notQBpop = function(obj){
        var _type = 1;  //值为1：普通的非QB提示；值为2：查看答案详情时的非QB提示；值为3：QB版本过低
        if(obj !== undefined){
            _type = obj.type || '';
        }
        var _html = '';
        if(_type == 1){
            ...
            _html = '<p style="text-align: center;font-size: 20px;">您的QQ浏览器版本过低，请下载最新版QQ浏览器。</p><br><br>';
        }
        _html += '<div class="btn-cont"><a onclick="this.href = \'http://dldir1.qq.com/invc/tt/QQBrowser_Setup_ValentineDay2015.exe\';clickReport(\'BROWSER.ACTIVITY.LOVER.QBDOWNLOADCLICK\');" href="javascript:;" class="btn btn-downloadQB">下载QQ浏览器</a></div>';
        dialog({body:_html});
    };
    ...
    var dialog = function(obj){
        ...
        var ObjCss, popWrap, popBox, popClose, popBg;
...
window.qb = {
    ...
    data: [
        ...
        },
        {
            ...
            "option" : ["不敢亲幼儿园暗恋的TA","后悔没做过后悔的事情","每件事情做完了就后悔","吵完架才想起来怎么还嘴","其他"],
            "letter" : ["A","B","C","D","E"]
        },
        {
            "question": "我为什么和前任分手？",
