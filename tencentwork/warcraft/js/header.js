...
Nav = (function ($) {
	...
	var COOKIE_INIT_ARG = {domain:'.qq.com',path:'/',expires:24*60*60};
	var m_navData;
	var m_temp = {
	...
	var _setLogin = function(){
		...
		qq.login.bind('logout', function() {
			qv.cookie.clear('_uin', COOKIE_INIT_ARG);
			qv.cookie.clear('_nick', COOKIE_INIT_ARG);
			qv.cookie.clear('isVip', COOKIE_INIT_ARG) ;
			_fillUserInfo();
		});
