	...
	var header = '\
		<div class="mod_gst">\
			<div class="mod_gst_main">\
				<a id="logo-btn" href="http://tq.qq.com/qbrcenter/index.html?ADTAG=wuxia" title="QQ浏览器特权中心" target="_blank"></a>\
				<a id="tq" href="http://tq.qq.com?ADTAG=wuxia&adtag=wuxia" target="_blank"></a>\
				<div class="mod_gst_userinfo" id="navUserInfo"></div>\
                <a id="header-qb" title="QQ浏览器下载" href="http://dldir1.qq.com/invc/tt/QQBrowser_Setup_DY_tymyd.exe#?ADTAG=SNO=" onclick="report(\'BROWSER.ACTIVITY.WUXIA.QBDOWNLOADCLICK\');"></a>\
			</div>\
		</div>';
