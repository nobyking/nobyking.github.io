    ...
    var tips = {
        ...
        7 : function(k){
            html = "<p style='padding-top: 30px;'>只有QQ浏览器用户才能参与领福利哦，快去安装吧～</p>\
                <div class='P_btns'>\
                    <a href='http://qb.wsd.com/files/qbbuild_v8_channel/upload/QQBrowser_Setup_video_LYF.exe?ADTAG=&SNO=' class='btn btn_pop' onclick='window.api.clickReport('BROWSER.ACTIVITY.NZCM.QBDOWNLOADCLICK');window.api.dialog.hide();'><span>安装QQ浏览器</span></a>\
                </div>";
            return html;
        },
